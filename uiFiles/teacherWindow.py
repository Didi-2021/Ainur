...
class Ui_teacher_window_dialog(object):
    ...
    def retranslateUi(self, teacher_window_dialog):
        ...
        teacher_window_dialog.setWindowTitle(_translate("teacher_window_dialog", "Управляющий"))  #Учитель
        self.pushButton.setText(_translate("teacher_window_dialog", "Сменить профиль"))  #
        self.class_label.setText(_translate("teacher_window_dialog", "Код книента"))  #Класс
        self.teacher_name.setText(_translate("teacher_window_dialog", "ФИО"))  #
        self.subject_label.setText(_translate("teacher_window_dialog", "Услуга"))  #Предмет
        self.student_label.setText(_translate("teacher_window_dialog", "Клиент"))  #Ученик
    ...
    def select_teacher_info(self, name):
        ...
        self.subject_combobox.clear()  # Услуга
        self.student_combobox.clear()  # Клиент
        self.class_combobox.clear()  # Код клиента
